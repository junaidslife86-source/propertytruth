...
function LoginForm() {
  ...
  const { configured, user, loading, signInGoogle, signInEmail, signUpEmail } =
    useAuth();
      ...
      <Card>
        <CardContent className="space-y-4 p-6 text-center">
          <p className="text-sm text-on-surface-variant">
            Firebase Auth is not configured. Add your Firebase client keys to{" "}
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-background px-2 font-label-caps text-on-surface-variant">
            Or email
          </span>
        </div>
      </div>
      ...
      >
        ...
        <TabsContent value="signin">
          <form className="space-y-4" onSubmit={(e) => void handleEmailSubmit(e)}>
            ...
            <Button type="submit" className="w-full bg-secondary" disabled={busy}>
          ...
          <form className="space-y-4" onSubmit={(e) => void handleEmailSubmit(e)}>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setPassword(e.target.value)}
              />
              <p className="text-xs text-on-surface-variant">At least 6 characters</p>
            </div>
            <Button type="submit" className="w-full bg-secondary" disabled={busy}>
...
export default function LoginPage() {
  return (
    <div className="mx-auto max-w-md space-y-8 px-5 py-10 pb-24">
      <Link
        href="/"
      ...
      <div className="space-y-2 text-center">
        <h1 className="font-[family-name:var(--font-manrope)] text-2xl font-bold tracking-tight">
          Sign in to PropertyTruth
        </h1>
        <p className="text-sm text-on-surface-variant">
          Save reports, sync strata scans, and keep your buyer preferences across
          devices.
        </p>
      </div>
